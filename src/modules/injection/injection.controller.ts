...
export class InjectionController {
  ...
  @ApiOperation({
    summary: 'Создать инъекцию',
    description: `Инъекции делятся по типу на: ${Object.values(InjectionEnum)}`,
  })
  @Post()
  ...
  findAllNeedle(
    ...
    @Query() searchParams: InjectionSearchQuery,
  ) {
  ...
  update(
    ...
    @Body() updateNeedleDto: UpdateInjectionDto,
  ) {
